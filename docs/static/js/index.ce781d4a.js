...
var _reactDnd = __webpack_require__(/*! react-dnd */ "./node_modules/react-dnd/lib/cjs/index.js");

var _reactDndHtml5Backend = _interopRequireDefault(__webpack_require__(/*! react-dnd-html5-backend */ "./node_modules/react-dnd-html5-backend/lib/cjs/index.js"));
...
function Card(_ref) {
  var isDragging = _ref.isDragging,
      dragSource = _ref.dragSource,
      text = _ref.text;
  var opacity = isDragging ? 0.5 : 1;
  return dragSource(_react.default.createElement("div", {
    style: {
      opacity: opacity
    }
  }, text));
...
var cardSource = {
  beginDrag: function beginDrag(props) {
    console.log('start');
    return {
      text: props.text + '(start dragg...)'
    };
  },
  isDragging: function isDragging(props) {
    console.log('dragging');
    return {
      text: props.text + '(dragging...)'
    };
  }
  /**
...
var DragItem = (0, _reactDnd.DragSource)(ItemTypes.CARD, cardSource, collect)(Card);

function App() {
  return _react.default.createElement(_reactDnd.DragDropContextProvider, {
    backend: _reactDndHtml5Backend.default
  }, _react.default.createElement(DragItem, {
    text: "hello dnd"
  }));
}
...
__webpack_require__(/*! D:\wamp\www\github-projects\react-dnd-test\node_modules\packez\lib\fetchPolyfills.js */"./node_modules/packez/lib/fetchPolyfills.js");
__webpack_require__(/*! D:\wamp\www\github-projects\react-dnd-test\node_modules\packez\lib\polyfills.js */"./node_modules/packez/lib/polyfills.js");
module.exports = __webpack_require__(/*! D:\wamp\www\github-projects\react-dnd-test\examples\index.js */"./examples/index.js");


/***/ })

/******/ });
//# sourceMappingURL=index.ce781d4a.js.map